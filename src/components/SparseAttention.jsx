...
export default function SparseAttention() {
  ...
  const t = key => matrixI18n[lang][key] ?? explorerI18n[lang][key] ?? canvasI18n[lang][key] ?? i18n[lang][key] ?? key;
