...
const i18n = {
  en: {
    ...
    chapters: 'Choose your next deep dive.', chapterIntro: 'Follow the suggested order, or take a branch. Each chapter links to the foundations it uses.',
  ...
  zh: {
    ...
    chapters: '选择下一次深入探索。', chapterIntro: '按推荐顺序逐层探索，也可以选择分支；每章提供相关基础的直达入口。',
